...
export function ContentPillars() {
  return (
    <section className="mb-12">
      <h2 className="text-lg font-semibold text-gray-900 mb-4 text-center">Jelajahi Berdasarkan Topik</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {CONTENT_PILLARS.map((pillar) => (
          <Link key={pillar.id} href={pillar.href}
            className="p-4 rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-blue-50/50 transition-colors group">
