    ...
    <div className="py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">{about.story}</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <Card>
            <h2 className="text-xl font-semibold text-blue-900 mb-3">Misi Kami</h2>
            <p className="text-gray-600">{about.mission}</p>
          </Card>
          <Card>
            <h2 className="text-xl font-semibold text-blue-900 mb-3">Visi Kami</h2>
        ...
        {about.achievements && (
          <div className="bg-blue-900 rounded-2xl p-8 mb-16">
