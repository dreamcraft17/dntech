...
export function TestimonialCarousel({ testimonials, autoPlay = true }: TestimonialCarouselProps) {
  ...
  return (
    <div className="relative">
      <div className="min-h-[220px] rounded-lg border border-gray-200 bg-white p-8">
        ...
        <div className="mt-6 flex items-center gap-4">
          <div className="h-12 w-12 rounded-full bg-blue-100 flex items-center justify-center text-blue-900 font-bold text-lg">
            {t.clientName.charAt(0)}
          </div>
          <div>
            <div className="font-semibold text-gray-900">{t.clientName}</div>
            <div className="text-sm text-gray-500">{t.position || t.title}{t.company ? `, ${t.company}` : ''}</div>
          </div>
