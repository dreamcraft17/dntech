  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="relative w-full max-w-lg rounded-2xl bg-white shadow-2xl p-6 max-h-[90vh] overflow-y-auto">
        <button onClick={dismiss} className="absolute top-4 right-4 p-1 text-slate-400 hover:text-slate-600" aria-label="Close">
          <X className="h-5 w-5" />
        </button>
        <h2 className="text-xl font-bold text-slate-900 pr-8">Wait! Before you go...</h2>
        <p className="mt-2 text-sm text-slate-600">
          Get a free consultation with our experts. Tell us about your project and we will respond within 24 hours.
        </p>
        <div className="mt-6">
