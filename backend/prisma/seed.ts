  ...
  const services = [
    {
      ...
      seoTitle: 'Enterprise Software Development Indonesia',
    ...
    },
    {
      ...
      seoTitle: 'Web & Mobile App Development Jakarta',
    ...
    },
    {
      ...
      seoTitle: 'Cloud Migration & DevOps Services',
      seoDescription: 'Migrasi AWS/Azure, Kubernetes, CI/CD pipeline, dan monitoring untuk infrastruktur enterprise.',
      features: [
    ...
    },
    {
      ...
      category: 'Consulting',
      seoTitle: 'IT Consulting & Digital Transformation',
      seoDescription: 'Konsultasi digital transformation, technology assessment, dan security audit untuk enterprise Indonesia.',
      features: [
