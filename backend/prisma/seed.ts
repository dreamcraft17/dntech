...
async function main() {
  ...
  await prisma.siteSettings.upsert({
    ...
    update: {
      trustBadges: [
        { icon: 'shield', label: 'ISO 27001 Certified', description: 'Information Security Management' },
        { icon: 'award', label: '1000+ Projects', description: 'Delivered successfully' },
        { icon: 'check', label: '50M+ Users Served', description: 'Across client applications' },
        { icon: 'zap', label: 'AWS Partner', description: 'Cloud infrastructure expertise' },
      ],
      clientLogos: [
    ...
    create: {
      ...
      aboutContent: {
        ...
        values: [
          ...
          { title: 'Excellence', description: 'Kualitas terbaik dalam setiap deliverable' },
        ],
        achievements: [
          '100+ Proyek Selesai',
          '50+ Klien Enterprise',
      ...
      termsContent: '<h1>Terms of Service</h1><p>By using DN Tech services, you agree to these terms.</p>',
      privacyContent: '<h1>Privacy Policy</h1><p>We respect your privacy and protect your personal data.</p>',
      trustBadges: [
        { icon: 'shield', label: 'ISO 27001 Certified', description: 'Information Security Management' },
        { icon: 'award', label: '1000+ Projects', description: 'Delivered successfully' },
        { icon: 'check', label: '50M+ Users Served', description: 'Across client applications' },
  ...
  const services = [
    {
      ...
      features: [
        { title: 'Custom ERP/CRM', description: 'Sistem manajemen bisnis tailored' },
        { title: 'API Integration', description: 'Integrasi dengan sistem legacy' },
        { title: 'Microservices Architecture', description: 'Arsitektur modern dan scalable' },
      ],
    ...
    },
    {
      ...
      features: [
        ...
        { title: 'iOS & Android Apps', description: 'Aplikasi mobile cross-platform' },
        { title: 'E-Commerce Solutions', description: 'Platform jual-beli online' },
      ],
      status: 'active' as const,
      displayOrder: 2,
    },
    {
      ...
      features: [
        { title: 'AWS/Azure Migration', description: 'Migrasi cloud yang aman' },
        { title: 'Kubernetes & Docker', description: 'Container orchestration' },
        { title: 'Monitoring & Alerting', description: 'Observability stack lengkap' },
      ],
      status: 'active' as const,
      displayOrder: 3,
    },
    {
      ...
      category: 'Consulting',
      features: [
        { title: 'Digital Transformation', description: 'Roadmap transformasi digital' },
        { title: 'Technology Assessment', description: 'Audit infrastruktur IT' },
        { title: 'Security Audit', description: 'Penilaian keamanan sistem' },
      ],
      status: 'active' as const,
      displayOrder: 4,
    },
  ...
  const blogPosts = [
    {
      ...
      content: '<p>Industri teknologi enterprise terus berkembang pesat. Berikut 5 tren utama yang perlu diperhatikan perusahaan Anda di tahun 2026.</p><h2>1. AI-Powered Automation</h2><p>Artificial Intelligence semakin terintegrasi dalam proses bisnis...</p><h2>2. Edge Computing</h2><p>Processing data lebih dekat ke sumber untuk latency rendah...</p>',
      excerpt: 'Pelajari tren teknologi enterprise terbaru yang akan membentuk bisnis di 2026.',
      category: 'Technology',
      tags: ['enterprise', 'trends', '2026'],
    ...
    },
    {
      ...
      content: '<p>Migrasi ke cloud bukan lagi privilege perusahaan besar. UMKM juga bisa memanfaatkan cloud computing.</p><h2>Mengapa Cloud?</h2><p>Biaya infrastruktur lebih rendah, scalability, dan keamanan data...</p>',
      excerpt: 'Step-by-step guide migrasi cloud yang affordable untuk UMKM Indonesia.',
      category: 'Cloud',
      tags: ['cloud', 'umkm', 'migration'],
      status: 'published' as const,
    ...
    },
    {
      ...
      content: '<p>Keamanan aplikasi web adalah prioritas utama. Berikut best practices yang wajib diterapkan.</p><h2>OWASP Top 10</h2><p>Pahami dan mitigasi 10 vulnerability paling kritis...</p>',
      excerpt: 'Implementasi keamanan web application sesuai standar OWASP.',
      category: 'Security',
  ...
  const faqs = [
    { question: 'Apa layanan yang ditawarkan DN Tech?', answer: 'Kami menawarkan enterprise software development, web & mobile development, cloud & DevOps, dan IT consulting.', category: 'General', displayOrder: 1 },
